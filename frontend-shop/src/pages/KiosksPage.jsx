      ...
      <div className={styles.content}>
              ...
              {kiosks.map((kiosk) => (
                ...
                >
                  <div className={styles.kioskInfo}>
                    ...
                    <span className={styles.kioskLocation}>
                      {kiosk.location}
                    </span>
                  </div>
                  <Button
        ...
        <div className={styles.kioskDetail}>
          {selectedKiosk ? (
            <>
              ...
              {kioskProducts.length === 0 ? (
                <p className={styles.emptyMessage}>
                  No products assigned to this kiosk
                </p>
              ) : (
            ...
            <p className={styles.emptyMessage}>
              Select a kiosk to view details
            </p>
          )}
        </div>
      </div>
            ...
            <form onSubmit={handleAddKiosk}>
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  value={newKiosk.name}
                  onChange={(e) =>
                    setNewKiosk({ ...newKiosk, name: e.target.value })
                  }
                  required
                />
              </div>
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewKiosk({ ...newKiosk, location: e.target.value })
                  }
                  required
                />
              </div>
